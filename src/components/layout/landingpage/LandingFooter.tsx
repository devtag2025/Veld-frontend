      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white tracking-tight">Veld</span>
            </Link>
            <p className="text-sm text-gray-400 leading-relaxed max-w-xs mb-6">
              The modern platform for outfitters to manage bookings, contracts, leads, and operations — all in one place.
            </p>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} Veld. All rights reserved.
          </p>
          <p className="text-sm text-gray-500">
            Designed for the modern outfitter 🌿
          </p>
        </div>
      </div>
    </footer>
